...
function addSong() {
    ...
    +line, function (error, response, body) {body = JSON.parse(body); if (body.type!="success"||settings.verbose) {sonia.say('linaea', "There was an error adding '"+line+"' to the playlist.");
    ...
    +line);
    sonia.say('linaea', "Body: "+JSON.stringify(body));} })}); // TODO Change the song picker to be non-random
